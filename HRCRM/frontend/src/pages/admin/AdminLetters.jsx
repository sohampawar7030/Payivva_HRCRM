    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-subtitle">Generate and manage all employee letters</div>
        </div>
            ...
            <tbody>
              {rows.map((l) => (
                <tr key={l.id}>
                  ...
                  <td>
                    {l.pdfContent && <button className="btn btn-secondary btn-sm" onClick={() => openPdf(l.id)}>PDF</button>}
                  </td>
                </tr>
              ))}
            </tbody>
